...
static inline void inlineSumInLocalMemory(const int nIndex, const int nrOfElems, const int divs, const int subdivs, __local volatile FPT *ldata, __global FPT *gdata, const int size)
{
    ...
    */
    ...
    __private int lnrOfElems = divs;
    __private int ldivs = subdivs;
    while(nrOfElems >= 2)
    {
        if((nIndex < ldivs) && (nIndex + ldivs < lnrOfElems))
        {
            ldata[nIndex] += ldata[nIndex + ldivs];
        }
        barrier(CLK_LOCAL_MEM_FENCE);
        lnrOfElems = ldivs;
        ldivs = (ldivs + (MODULO2(ldivs)))/2;
    }
    if(nIndex == 0)
    {
...
__kernel void sumInLocalMemory(__global FPT *gdata, __local volatile FPT* ldata, const int size)
{
    ...
    */    
    ...
    __private int subdivs = (divs + (MODULO2(divs)))/2;
    
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata, size);
}
...
__kernel void translationSumInLocalMemoryCombined(__global FPT *gdata0,__global FPT *gdata1,__global FPT *gdata2,__global FPT *gdata3,__global FPT *gdata4,__global FPT *gdata5,__global FPT *gdata6, __local volatile FPT* ldata, const int size)
{
    ...
    */
    ...
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata0, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata1, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata2, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata3, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata4, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata5, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata6, size);
}
...
const int size)
{
    ...
    */
    ...
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata5, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata6, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata7, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata8, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata9, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata10, size);
}
...
const int size)
{
    ...
    */
    ...
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata9, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata10, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata11, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata12, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata13, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata14, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata15, size);
}
...
const int size)
{
    ...
    */
    ...
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata14, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata15, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata16, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata17, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata18, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata19, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata20, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata21, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata22, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata23, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata24, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata25, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata26, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata27, size);
    inlineSumInLocalMemory(nIndex, nrOfElems, divs, subdivs, ldata, gdata28, size);
}
